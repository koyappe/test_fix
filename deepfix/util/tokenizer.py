...
class C_Tokenizer():
    ...
    print "tokenizer.py  C_Tokenizer..class passed"
    ...
    print "tokenizer.py  escape passed"
        
        return repr(string)[1:-1]

    def _tokenize_code(self, code):
    
    print "tokenizer.py  tokenize_code passed"
    ...
    print "tokenizer.py  sanitize_brackets passed"
    ...
    def tokenize(self, code, keep_format_specifiers=False, keep_names=True, \
        ...
        print "tokenizer.py  tokenize passed" #debug
