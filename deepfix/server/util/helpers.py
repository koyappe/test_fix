...
def compilation_errors(string):
    ...
    print "compilation_errors passed"
...
def recompose_program(lines):
    ...
    print "recompose_program passed"
...
def extract_line_number(line):
    ...
    print "extract_line_number passed"
...
def fix_ids_are_in_program(program_string, fix_string):
    ...
    print "fix_ids_are_in_program passed"
...
def reverse_name_dictionary(dictionary):
    ...
    print "reverse_name_dictionary passed"
...
def make_dir_if_not_exists(path):
    ...
    print "make_dir_if_not_exists passed"
...
def calculate_token_level_accuracy(Y, Y_hat):
    ...
    print "calculate_token_level_accuracy passed"
...
def calculate_localization_accuracy(Y, Y_hat, dictionary):
    ...
    print "calculate_localization_accuracy passed"
...
def calculate_repair_accuracy(Y, Y_hat):
    ...
    print "calculate_repair_accuracy passed"
