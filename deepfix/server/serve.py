...
parser.add_argument('dropout', help='Probability to use for dropout',
        type=float)
parser.add_argument('task', help="One of 'typo' or 'ids' (undeclared)",
        choices=['typo', 'ids'])
parser.add_argument('-v', '--vram', help='Fraction of GPU memory to use',
...
def process():
    global deepfix
    print "*******************"
    print request.forms.get('source_code')
    print "*******************"
